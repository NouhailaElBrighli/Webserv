...
{
	for (std::vector<std::string>::iterator files_itr = files_to_remove.begin(); files_itr != files_to_remove.end(); files_itr++)
	{
...
void	MainClient::set_files_to_remove(std::string file)
{
